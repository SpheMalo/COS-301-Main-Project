   ...
   <div class="position_content" id="page_position_content">
    <div class="clearfix colelem" id="pu72"><!-- group -->
     <div class="browser_width" id="u72-bw">
      <div class="shadow gradient" id="u72"><!-- simple frame --></div>
     </div>
     <div id="u216"><!-- rasterized frame --></div>
    </div>
...
<html >
  ...
  <body>
	...
	<ul class="bgf-bubbles">
     ...
     <div class="PamphletWidget clearfix widget_invisible grpelem" id="pamphletu275"><!-- none box -->
      ...
      <div class="popup_anchor" id="u276popup">
       <div class="ContainerGroup rgba-background clearfix" id="u276"><!-- stack box -->
