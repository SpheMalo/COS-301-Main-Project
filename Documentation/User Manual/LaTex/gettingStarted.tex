...
\par{Users will have to visit \href{https://figbookinterface.mybluemix.net}{\textbf{Figbook}} and click on 'Register'. The following will appear. }
...
\subsection{Log in}
\par{If you already have an account, go to \href{https://figbookinterface.mybluemix.net}{\textbf{Figbook}} and click on the 'Log in' button. Enter either your username or email address (that you entered when you registered) and click 'log in'. If you have an existing account, you will be successfully logged in to the system.\\ \\ If you have no account, see the section above this one before continuing.}