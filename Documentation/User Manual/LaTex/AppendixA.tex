...
\subsection{Google Chrome}
		...
		\begin{figure}[!h]
		\centering
			\includegraphics[scale=0.7]{images/javascriptChrome1.png}
		...
		\begin{figure}[!h]
		\centering
			\includegraphics[scale=0.7]{images/javascriptChrome3.png}
			\caption{Enabling Javascript on Chrome: Step 3}
		\end{figure}
		
		\begin{figure}[!h]
		\centering
			\includegraphics[scale=0.7]{images/javascriptChrome4.png}
