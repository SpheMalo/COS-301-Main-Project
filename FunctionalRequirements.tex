...
\item \textbf{Comment – priority: important  }\\
\par{This use case which allows one to comment on a  manuscript.}

\textbf{service contract:} The service contract for the comment service is shown in figure below.  The comments are added to the manuscript.
\begin{figure}[h]
\includegraphics[height=250px, width=500px]{epsImages/Communication/comment.eps}
\caption{Service contract for commenting on a menuscript}
\end{figure}
\end{enumerate}
\end{document}