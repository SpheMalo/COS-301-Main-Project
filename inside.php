...
<head>
	...
	<!-- js folder Scripts linked here-->
	<script src="js/jquery-1.10.2.min.js"></script> 
	<script src="js/jquery.lightbox.js"></script>
	<script src="js/templatemo_custom.js"></script>
	<script src="js/easyResponsiveTabs.js" type="text/javascript"></script>
	
	<!--scripts folder Scripts linked here-->
	 ...
	 <script>
		...
		function wiki_logout() {
			$.post('scripts/mediawiki/api.php?action=logout'+'&format=json', function(data) {
				//this  deletes the local storage and cookie for username.
...
<body>
	<div class="wrapper1"> <!-- Also contains all the other content in body -->
