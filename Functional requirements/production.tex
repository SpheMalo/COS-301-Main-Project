...
\begin{figure}[h]
\includegraphics[height=350px, width=500px]{epsImages/Production/SelectCopyEditor.eps}
...
\begin{figure}[h]
\includegraphics[height=350px, width=500px]{epsImages/Production/SelectProofReader.eps}
