...
\begin{figure}[h]
\includegraphics[height=300px, width=500px]{epsImages/ManuscriptManagement/editManuscript.eps}
...
\begin{figure}[h]
\includegraphics[height=300px, width=500px]{epsImages/ManuscriptManagement/sendManuscriptServiceContract.eps}
